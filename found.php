...
<div id = "header">
    ...
    <div id = "message">
        <div id = "messageT1"> Found Something? </div>
...
if ($_SERVER [ 'REQUEST_METHOD' ] == 'POST' ){
	...
	if ( !valid_item_name($item_name) )
		...
		insert_found_record($dbc, $finder, $item_name, $description, $location_id, $create_date);
}
...
?>    
    ...
    <table>
        ...
        <tr><td>Enter your name here:</td><td><input type = "text" name = "finder" value="<?php if (isset($_POST['finder'])) echo $_POST['finder'];?>"></td></tr><br>
