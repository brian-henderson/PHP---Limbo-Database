...
function show_all_records($dbc) {
        ...
        $query = 'SELECT id, item_name, create_date, update_date, status FROM stuff' ;
...
# Inserts a record into the table
function update_record($dbc, $id, $item_name, $description, $location_id, $upate_date, $owner, $finder, $status) {
	$query = 'UPDATE stuff set id = '.$id.', set item_name = '.$item_name.', set description = '.$description.', set location_id = '.$location_id.', set create_date= '.$create_date.' , set update_date= '.$update_date.', set owner= '.$owner.', set finder = '.$finder.', set status = '.$status.')' ;
  show_query($query);
